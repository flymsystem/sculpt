...
<div style="display:flex;justify-content:space-between;align-items:flex-start;padding-bottom:16px;margin-bottom:22px;border-bottom:2px solid #1A6FD4;">
  <div><div style="font-size:16px;font-weight:700;letter-spacing:0.12em;color:#0A84FF;line-height:1;text-transform:uppercase;">D Sculpt Fitness</div><div style="font-size:10px;color:#888;letter-spacing:0.15em;text-transform:uppercase;margin-top:4px;">Member Report</div></div>
...
<div style="margin-top:30px;padding-top:14px;border-top:1px solid #ddd;font-size:10px;color:#999;text-align:center;">Generated by D Sculpt Fitness &middot; ${escHtml(gymName)} &middot; ${escHtml(dateStr)}<br>This document contains confidential data. Handle with care.</div>
</body></html>`;
...
<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:16px;border-bottom:2px solid #1A6FD4;padding-bottom:12px;">
  <div><div style="font-size:15px;font-weight:700;letter-spacing:0.12em;color:#0A84FF;text-transform:uppercase;">D Sculpt Fitness</div><div style="font-size:9px;color:#888;text-transform:uppercase;letter-spacing:0.15em;margin-top:3px;">Complete Data Backup</div></div>
...
<div style="margin-top:24px;padding-top:10px;border-top:1px solid #ddd;font-size:9px;color:#999;text-align:center;">Generated by D Sculpt Fitness · ${escHtml(gymName)} · ${escHtml(dateStr)} · Confidential</div>
</body></html>`;
